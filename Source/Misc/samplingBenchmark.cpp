...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    uhd::stream_args_t stream_args_rx(rx_cpu, rx_otw);
    stream_args_rx.channels = rx_channel_nums;
    stream_args_rx.args = uhd::device_addr_t(rx_stream_args);
    ...
    uhd::stream_args_t stream_args_tx(tx_cpu, tx_otw);
    stream_args_tx.channels = tx_channel_nums;
    stream_args_tx.args = uhd::device_addr_t(tx_stream_args);
